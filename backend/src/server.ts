...
/**
 * Boots the Fastify application: builds it, starts listening, wires up
 * graceful shutdown, and logs the outcome. Returns the running app instance
 * so callers (e.g. tests) can close it manually if needed.
 */
